...
# Find the most recent AL2023 Node.js 20 solution stack in this region
data "aws_elastic_beanstalk_solution_stack" "nodejs20_al2023" {
    most_recent = true
    name_regex  = "^64bit Amazon Linux 2023 v[0-9]+\\.[0-9]+\\.[0-9]+ running Node\\.js 20$"
}
